<template>
  <div class="min-h-screen bg-zinc-900 flex items-center justify-center">
    <div class="w-[414px] bg-black text-white font-body-md min-h-screen relative">
      <header class="fixed top-0 left-1/2 -translate-x-1/2 w-[414px] border-b-4 border-white bg-black text-white flex justify-between items-center px-6 h-24 z-50">
      ...
      <main class="pt-24 pb-28 px-6 w-full flex flex-col gap-stack-gap">
        ...
        <div class="grid grid-cols-2 gap-4">
          <button class="flex flex-col items-center justify-center gap-4 py-12 px-4 bg-deep-blue border-4 border-white rounded-xl active:scale-95 transition-transform">
          ...
          <button class="flex flex-col items-center justify-center gap-4 py-12 px-4 bg-black border-4 border-white rounded-xl active:scale-95 transition-transform">
          ...
          <router-link to="/userpersonal" class="flex flex-col items-center justify-center gap-4 py-12 px-4 bg-black border-4 border-white rounded-xl active:scale-95 transition-transform">
        ...
        <div class="mt-8 border-4 border-white p-6 bg-black rounded-xl flex flex-col gap-8 items-center">
          <div class="w-full flex flex-col gap-4">
            ...
            <button class="w-full h-20 bg-white text-black font-button-text border-4 border-white rounded-xl active:bg-zinc-300 transition-colors">
              立即开启
            </button>
          </div>
        </div>
